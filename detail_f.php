	...
	<div class="col-xs-8">
		...
		?>
			...
			<div class="row">
				...
				<?php
				/*
				 echo '依頼方式：プロジェクトorタスク<br>';//+SQL
				 echo 'カテゴリ：<br>';//+SQL
				 echo '第3者:ありorなし';//SQL(outsider)
				 */
				echo '依頼方式：タスク<br>';//+SQL
				echo 'カテゴリ：<br>';//+SQL
				echo '第3者:なし';//SQL(outsider)
				?>
				</div>
				<div class="col-xs-6">
				<?php
				/*
				 echo '募集開始日：'.$sdate.'<br>';
				 echo '募集締切日：'.$edate.'<br>';
				 echo 'ワーク当日：2013-11-15<br>';//SQL(テーブル、たぶんwdate)
				 */
				echo '募集開始日：2016-08-01<br>';
				echo '募集締切日：2016-08-05<br>';
				echo 'ワーク当日：2016-08-07<br>';//SQL(テーブル、たぶんwdate)
				?>
				</div>
			</div>
			<br>
